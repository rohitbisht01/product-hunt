...
const DeleteProduct = ({ productId }: DeleteProductProps) => {
  ...
  return (
    <div className="">
      <button
        className="cursor-pointer bg-red-100 p-4 flex justify-center rounded-md items-center"
      ...
      >
        <div>
          ...
          <div className="flex justify-end mt-10">
            <button
              className="bg-white text-red-500 border text-sm rounded-full border-red-500  px-4 py-2 mr-4 font-light cursor-pointer"
