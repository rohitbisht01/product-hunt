    ...
    <Sheet>
      <SheetTrigger>
        <div className="flex items-center">
          ...
          {unreadNotifications > 0 && (
            <div className="absolute ml-3 mb-3 bg-red-500text-white rounded-full h-4 w-4 flex items-center justify-center text-xs">
              {unreadNotifications}
            </div>
          )}
        </div>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>View all your notifications here</SheetDescription>
        </SheetHeader>
        {unreadNotifications === 0 ? (
          <>
